...
public class Sportstest 
{
	...
	public static void main(String[] args) {
		...
		Sports[] ALL_Sports_Data = new Sports[6];
		
		ALL_Sports_Data[0]= new Basketball("Basketball",12,true,false,"Red");
		ALL_Sports_Data[1]= new Baseball("Baseball",12,false,true,"TITANS");
		ALL_Sports_Data[2]= new Basketball("Basketball",12,false,true,"voilet");
		ALL_Sports_Data[3]= new Basketball("Basketball",11,true,true,"cyan");
		ALL_Sports_Data[4]= new Baseball("Baseball",11,false,false,"RETRO");
		ALL_Sports_Data[5]= new Baseball("Baseball",12,true,true,"NIGHTS");
